  ...
  const trending = [
    {
      ...
      title:
        "'I Literally Tried Everything' — 11 Cheap Habits Cat Owners With Allergies Say Made the Biggest Difference",
    },
    {
      href: articleHref("blog/home-decor-less-than-50.html"),
      title:
        "The One Home Decor Trick Designers Swear By — And It Costs Less Than $50",
    },
    {
      href: articleHref("4-products-changed-everything.html"),
      title:
        "I Am A Busy Mom Who Hates Cleaning And These 4 Products Changed Everything",
    },
    {
      href: articleHref(
...
function insertFooter(pageType = "root") {
  const privacyPath =
    pageType === "blog" ? "../privacy-policy.html" : "privacy-policy.html";
  const termsPath =
    pageType === "blog" ? "../terms-of-service.html" : "terms-of-service.html";
  const blogPath = pageType === "blog" ? "index.html" : "blog/index.html";
  const qWellness = `?category=${encodeURIComponent("Wellness")}`;
  const qDecor = `?category=${encodeURIComponent("Home Decor")}`;
  const qCleaning = `?category=${encodeURIComponent("Home Cleaning")}`;
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  if (searchBtn && searchPanel && searchForm && searchInput) {
    ...
    const categoryResultsSection = document.getElementById(
      "siteSearchCategoryResultsSection",
    );
    const categoryResultsList = document.getElementById(
      "siteSearchCategoryResultsList",
    );
    const categoryResultsHeading = document.getElementById(
      "siteSearchCategoryResultsHeading",
    );
    const articleResultsSection = document.getElementById(
      "siteSearchArticleResultsSection",
    );
    ...
    function loadArticleRegistryScript(done) {
      ...
      const existing = document.querySelector(
        "script[data-chh-article-registry]",
      );
    ...
    function renderCategoryResultList(matches) {
      ...
      matches.forEach(function (entry) {
        ...
        a.href = entry.href;
        a.className =
          "site-search-sidebar__trending-link site-search-sidebar__trending-link--category";
    ...
    function updateSearchUI() {
      ...
      if (!hasCats && !hasArts) {
        ...
        if (categoryResultsHeading)
          categoryResultsHeading.textContent = "Matching categories";
        return;
      }
    ...
    searchPanel
      .querySelectorAll(".site-search-sidebar__trending-link")
  ...
  if (categoryParam && isBlogIndexListing) {
    const blogSections = document.querySelectorAll(
      ".blog-category-section[data-blog-category]",
    );
    if (blogSections.length) {
      ...
      blogSections.forEach(function (section) {
        const match =
          section.getAttribute("data-blog-category") === categoryParam;
      ...
      const testimonial =
        visibleSection &&
        visibleSection.querySelector(".blog-category-testimonial");
      ...
      if (testimonial && heroRow && heroCopy && visibleCount > 0) {
        ...
        const intro = visibleSection.querySelector(
          ".blog-category-section__intro",
        );
        if (intro) intro.hidden = true;
      }
    } else {
      document
        .querySelectorAll(".row .card[data-category]")
  ...
  (function injectCommentsUnderAdditionalReading() {
    ...
    function inferCommentTopicKey(pathname) {
      ...
      if (
        /decor|interior|design|luxe|room|studio|apartment|home-decor|adv_/.test(
          p,
        ) ||
      ...
      if (
        /clean|vacuum|living-room|minutes|spray|purifier|mattress|bedding|dust-mite|mite|laundry|kitchen|wipe|mop/.test(
          p,
        ) ||
      ...
      if (
        /dust|allerg|hay|pollen|sinus|cough|fatigue|mattress|bedding|air/.test(
          p,
        )
      )
        return "wellness";
        ...
        return [
          {
            ...
            body: "This is literally me. I wash bedding on hot, vacuum constantly, run a purifier… and still wake up congested. I never thought “looking clean” and neutralizing allergens were different things.",
            replies: [],
          },
          {
            author: "derek.t",
            meta: "10 hours ago · Chicago",
            body: "I almost bought another pricey HEPA vacuum before reading this. Glad I paused—sounds like I was chasing visible dust and missing what was left on the couch and mattress.",
            replies: [],
          },
          {
            author: "amina.r",
            meta: "4 hours ago · Atlanta",
            body: "Quick question: if I already wash sheets weekly, where should I start misting first—bed, rugs, or the living room sofa? Trying the 4-step routine this weekend.",
            replies: [],
          },
        ];
      }

      if (/compared-4-popular-house-allergen-sprays/.test(p)) {
        return [
          {
            author: "labmom_k",
            meta: "1 day ago · Denver",
            body: "The Clorox daily-application catch is so real. I need something I can actually stick with—every 3 days is more realistic for me than every day.",
            replies: [],
          },
          {
            author: "noah.p",
            meta: "10 hours ago · Boston",
            body: "Helpful that you broke down spray-and-go vs monthly deep-clean treatments. Allersearch sounded intense for everyday use.",
            replies: [],
          },
          {
            author: "rita.s",
            meta: "4 hours ago · Phoenix",
            body: "I didn’t realize how different these formulas are. The Pacagen Der p 1 / Der p 2 angle is what I’m looking into next.",
            replies: [],
          },
        ];
      }
        ...
        decor: [
          {
            ...
            body: "I’m bookmarking the lighting + layout tips—our tiny living room finally feels intentional instead of “random furniture.”",
            replies: [editorReply],
          },
          {
            author: "rico.m",
            meta: "1 week ago · SF",
            body: "The “one focal point” idea saved me. I stopped buying decor I liked individually and actually planned the wall first.",
            replies: [],
          },
          {
            author: "samira.p",
            meta: "6 days ago · Miami",
            body: "Question: for renters, what’s the best low-commitment swap that still reads “designed”? Peel-and-stick or textiles?",
            replies: [
              {
                author: "leah.v",
          ...
          },
          {
            ...
            body: "I tried the “less than $50” mindset and stopped impulse-buying decor. My space looks calmer with fewer, better pieces.",
            replies: [],
          },
          {
            author: "ivy.q",
            meta: "2 weeks ago · Austin",
            body: "This helped me stop chasing trends. I picked a palette and suddenly shopping got way easier.",
            replies: [],
          },
          {
            author: "noah.t",
            meta: "12 days ago · Denver",
            body: "I’m a maximalist at heart but my apartment was chaos. The “one hero moment per room” rule finally clicked.",
            replies: [],
          },
        ],
        cleaning: [
          {
            ...
            body: "The “reset, not deep clean” framing is what I needed. I can keep surfaces sane even when I’m slammed at work.",
            replies: [editorReply],
          },
          {
            author: "andre.g",
            meta: "5 days ago · NJ",
            body: "Air purifier + weekly bedding wash was the combo that actually moved the needle for dust in our bedroom.",
            replies: [],
          },
          {
            author: "patty_w",
            meta: "1 week ago · GA",
            body: "I started doing a 10-minute nightly tidy instead of marathon weekends. My stress level dropped a lot.",
            replies: [],
          },
          {
            author: "luis.r",
            meta: "9 days ago · TX",
            body: "Does anyone else get overwhelmed by “clean the whole house”? I like the idea of one zone per day.",
            replies: [
              {
                author: "dana.k",
          ...
          },
          {
            author: "helen.j",
            meta: "11 days ago · IL",
            body: "Vacuuming slower (actually overlapping passes) sounds silly but it helped more than vacuuming twice as often.",
            replies: [],
          },
          {
            author: "marcus.t",
            meta: "13 days ago · FL",
            body: "Kitchen reset: I wipe counters + load dishwasher every night. Mornings feel less chaotic.",
            replies: [],
          },
        ],
        cats: [
          {
            author: "catdad_mike",
            meta: "3 days ago · WA",
            body: "Fel d 1 finally made sense to me—why wiping surfaces helped even when I couldn’t see “dander.”",
            replies: [editorReply],
          },
          {
            author: "priya.k",
            meta: "6 days ago · TX",
            body: "We’re trying the “brush the cat + wash hands” habit before couch time. Small, but it reduced evening sneezes.",
            replies: [],
          },
          {
            author: "zoey.b",
            meta: "1 week ago · OR",
            body: "I’m allergic and I still wanted the cat on the bed sometimes. Dedicated throw blanket + weekly wash helped.",
            replies: [],
          },
          {
            author: "eli.n",
            meta: "8 days ago · NY",
            body: "Has anyone tried limiting the cat from the bedroom vs keeping the door open? Tradeoffs?",
            replies: [
              {
                author: "sam_c",
          ...
          },
          {
            author: "hana.m",
            meta: "12 days ago · CA",
            body: "I didn’t realize grooming spreads allergens. Changing where we brush the cat helped a ton.",
            replies: [],
          },
          {
            author: "oliver.p",
            meta: "14 days ago · MA",
            body: "The litter box location tip was underrated for us—less tracked dust near the couch.",
            replies: [],
          },
        ],
        dogs: [
          {
            author: "walkswithjax",
            meta: "4 days ago · CO",
            body: "Dog allergy talk is usually vague—this helped me understand saliva vs dander and what actually gets stirred up at home.",
            replies: [editorReply],
          },
          {
            author: "mia.s",
            meta: "9 days ago · AZ",
            body: "We added a “paws + face wipe” routine after walks. Sounds extra, but it cut down on itchy eyes.",
            replies: [],
          },
          {
            author: "greg.h",
            meta: "11 days ago · MN",
            body: "Bathing schedule is tricky—too often dries skin, too rarely leaves allergens. I’m still experimenting.",
            replies: [],
          },
          {
            author: "tara.l",
            meta: "2 weeks ago · WI",
            body: "HEPA in the main hangout room + keeping the dog off one chair made a bigger difference than I expected.",
            replies: [],
          },
        ],
        wellness: [
          {
            ...
            body: "The “why symptoms spike at night” part hit home. We changed pillow encasements + airflow and mornings feel clearer.",
            replies: [editorReply],
          },
          {
            author: "maria_c",
            meta: "2 days ago · Chicago",
            body: "I finally stopped blaming “random colds.” Tracking symptoms against cleaning days made patterns obvious.",
            replies: [],
          },
          {
            author: "aline.s",
            meta: "1 week ago · Austin",
            body: "Humidity + dust is my villain combo. I’m testing lower humidity at night—early signs are promising.",
            replies: [],
          },
          {
            author: "kevinm",
            meta: "2 weeks ago · New York",
            body: "This is the first article that didn’t shame me for not being a “perfect” cleaner. Practical beats ideal.",
            replies: [],
          },
          {
            author: "yasmin.f",
            meta: "10 days ago · NC",
            body: "Cough vs post-nasal drip vs asthma is confusing. I’m bringing this to my next appointment as talking points.",
            replies: [],
          },
          {
            author: "ben.r",
            meta: "13 days ago · UT",
            body: "I liked the plain-language breakdown. It helped me prioritize: bedroom first, then living room.",
            replies: [],
          },
        ],
        general: [
          {
            author: "maria_c",
            meta: "2 days ago · Chicago",
            body: "I appreciate how realistic this is. I picked two ideas from the article and actually kept them past week one.",
            replies: [editorReply],
          },
          {
            author: "jordan.k",
            meta: "5 days ago · Seattle",
            body: "Question: what’s the best “first domino” if you can only change one thing this weekend?",
            replies: [
              {
                author: "tanya_r",
          ...
          },
          {
            author: "aline.s",
            meta: "1 week ago · Austin",
            body: "Shared this with my partner—finally a cleaning/advice article that doesn’t feel like guilt-tripping.",
            replies: [],
          },
          {
            author: "kevinm",
            meta: "2 weeks ago · New York",
            body: "I bookmarked this for later, then ended up doing one tip the same day. That’s rare for me.",
            replies: [],
          },
          {
            author: "nina.d",
            meta: "9 days ago · Brooklyn",
            body: "Love the “explain why, then what to do” structure. Makes it easier to remember the takeaway.",
            replies: [],
          },
          {
            author: "rico.m",
            meta: "11 days ago · SF",
            body: "Would love a printable checklist version—but even without it, this was actionable.",
            replies: [],
          },
        ],
      };
    ...
    // Fixed offsets after publish so labels age naturally over time
    const COMMENT_OFFSET_HOURS = [6, 14, 22];
    const REPLY_OFFSET_HOURS = [10, 18, 26];

    function formatRelativeFromDate(then, now) {
    ...
    function commentPostedAt(publishDate, idx) {
      const base = publishDate
        ? new Date(publishDate.getTime())
        : new Date(Date.now() - 3 * 86400000);
      const hours = COMMENT_OFFSET_HOURS[idx] ?? 6 + idx * 8;
      return new Date(base.getTime() + hours * 3600000);
    }

    function replyPostedAt(publishDate, parentIdx) {
      const base = publishDate
        ? new Date(publishDate.getTime())
        : new Date(Date.now() - 3 * 86400000);
      const hours = REPLY_OFFSET_HOURS[parentIdx] ?? 12 + parentIdx * 8;
      return new Date(base.getTime() + hours * 3600000);
    }

    function withFreshMetas(thread, idx, seed, publishDate) {
      const now = new Date();
      const suffix = keepMetaSuffix(thread.meta);
      const postedAt = commentPostedAt(publishDate, idx);
      const safePosted =
        publishDate && postedAt < publishDate
          ? new Date(publishDate.getTime() + 60 * 60 * 1000)
          : postedAt > now
            ? now
            : postedAt;

      const replies = (thread.replies || []).map(function (reply) {
        let replyAt = replyPostedAt(publishDate, idx);
        if (replyAt < safePosted) {
          replyAt = new Date(safePosted.getTime() + 60 * 60 * 1000);
        }
        if (replyAt > now) replyAt = now;
        return Object.assign({}, reply, {
          meta: formatRelativeFromDate(replyAt, now) + keepMetaSuffix(reply.meta),
        });
      });
      return Object.assign({}, thread, {
        meta: formatRelativeFromDate(safePosted, now) + suffix,
        replies: replies,
      });
    }
    ...
    function renderCommentThread(thread, idx, seed, topicKey) {
      ...
      const stableId = String(
        hashString(`${topicKey}|${thread.author || ""}|${thread.body || ""}`),
      );
    ...
    function renderSection(seed) {
      ...
      const publishDate = parsePublishedDate();
      const pageThreads = pageSpecificThreads(pathname);
      const chosen = (
        pageThreads || pickUnique(threadPoolsForTopic(topicKey), seed, 3)
      ).map(function (t, idx) {
        return withFreshMetas(t, idx, seed, publishDate);
      });
      const list = chosen
        .map(function (t, idx) {
    ...
    function wireLikeButtons(seed) {
      ...
      scope.querySelectorAll(".chh-comment__btn--like").forEach(function (btn) {
        ...
        btn.addEventListener("click", function () {
          ...
          const nextDelta = nextLiked
            ? curDelta + 1
            : Math.max(0, curDelta - 1);
    ...
    function wireCommentComposer(seed) {
      ...
      function avatarForSavedComment(c, idx) {
        const custom =
          c && c.avatarUrl && String(c.avatarUrl).indexOf("data:") === 0;
        if (custom) return c.avatarUrl;
        return avatars[
          (seed + 10 + idx + hashString(String(c.author || ""))) %
            avatars.length
        ];
      }
      ...
      if (
        prof &&
        prof.avatarUrl &&
        String(prof.avatarUrl).indexOf("data:") === 0
      ) {
      ...
      form.addEventListener("submit", function (e) {
        ...
        if (list) {
          ...
          list.insertAdjacentHTML(
            "afterbegin",
            renderSavedComment(entry, Math.max(0, idx)),
          );
          wireLikeButtons(seed);
        }
      });
    ...
    const timer = setInterval(function () {
      ...
      tryInsert(tries);
      const inserted =
        document.getElementById(TARGET_ID)?.getAttribute(INSERTED_ATTR) === "1";
  ...
  (function injectMidArticleAds() {
    ...
    function anchorForAdIndex(index, h2s, paras, firstAdWrapper) {
      ...
      return (
        paras[Math.min(5, paras.length - 1)] || paras[paras.length - 1] || null
      );
    }
    ...
    function doInject() {
      ...
      MID_ADS.forEach(function (cfg, index) {
        if (blogContents.querySelector('[data-ad-slot="' + cfg.slot + '"]'))
          return;
        const adHtml = createAd(cfg);
        if (!adHtml) return;

        // Optional explicit mount: <div data-ad-before="uber-eats"></div>
        const beforeMount = blogContents.querySelector(
          '[data-ad-before="' + cfg.slot + '"]',
        );
        if (beforeMount) {
        ...
        const firstUber = blogContents.querySelector(
          '[data-ad-slot="uber-eats"]',
        );
